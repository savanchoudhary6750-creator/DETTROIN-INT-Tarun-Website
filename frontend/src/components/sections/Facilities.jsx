              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-3 px-4 rounded-xl bg-slate-800/80 hover:bg-slate-700/90 text-white font-bold text-xs border border-slate-700/80 hover:border-amber-500/50 backdrop-blur-md transition-all duration-300 flex items-center justify-center gap-2 group/btn shadow-md hover:-translate-y-0.5"
                  >
                    <Sparkles className="w-3.5 h-3.5 text-school-gold group-hover/btn:rotate-12 transition-transform duration-300" />
                    <span>View Facility Details</span>
                    <span className="text-school-gold font-bold text-sm transition-transform duration-300 group-hover/btn:translate-x-1 inline-block">→</span>
                  </button>
                </div>
